...
The following versions of the `Friendly-KHQR` project are currently being supported with security updates:
...
If you discover a vulnerability or security issue in the `Friendly-KHQR` package, please report it as soon as possible.

To report a vulnerability:

1. Send an email to [lifun716@gmaill.com](mailto:lifungg716@gmail.com) with a detailed description of the issue, steps to reproduce, and any other relevant information.
...
Thank you for helping us improve the security of `Friendly-KHQR`!
