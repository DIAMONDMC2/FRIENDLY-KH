<h1 align="center"> Friendly-KHQR (Unofficial NBC) </h1>
...
> You can integrate Friendly KHQR using either an official **NBC Friendly Developer Token** or a **Friendly Relay Token (`rbk...`)**.  
...
- <img src="https://cdn.jsdelivr.net/gh/bsthen/bsthen/bakong_tourists.png"
  ...
  <a href="https://play.google.com/store/apps/details?id=kh.gov.nbc.bakong.tourist" target="_blank">
      <img src="https://img.shields.io/badge/Google_Play-414141?style=flat&logo=google-play&logoColor=white" alt="Friendly-Bank"
           style="vertical-align: middle;" />
  </a>
...
- Python 3.8+
- A Friendly account with full KYC verification
- An NBC Bakong Developer Token or a **Friendly Relay Token (`rbk...`)**  
...
The Friendly-khqr package provides the KHQR class for generating QR codes, Deeplinks, MD5 hashes, and verifying Friendly KHQR transactions across a 4-state lifecycle (`PAID`, `SCANNED`, `UNPAID`, `EXPIRED`).
...
To generate QR code data for a transaction, create an instance of the `KHQR()` class with your official Friendly Token:
...
khqr = KHQR("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiOWYzNTAzNTIxMGRhNGFjZCJ9LCJpYXQiOjE3ODk0MzIwNzMsImV4cCI6MTc5NzIwODA3M30.bhvNRUsARR218kJyMtUDCtNN_1WLgTjfFZG8Eeu9a3A")
...
print(qr_string)
# String Result: 00020101021130490015vblckhppxxx@vbl01090098267210213Vattanac Bank5204000053038405802KH5915Phun Sophol, Mr6002PP6210070623804263044093
...
deeplink = khqr.generate_deeplink(
    ...
    appName="FRIENDLY-BANK" # (e.g., MSHOP)
)
print(deeplink)
...
> **Note:** To prevent unauthorized redirects, the domains for your `return_url` and `webhook_url` **must be whitelisted** before creating sessions. You can whitelist your domains instantly via the Telegram Bot: [👉 @KHMER_SHOP2_BOT](https://t.me/KHMER_SHOP2_BOT?start=relay_signup).
